...
1. **Study the [DEBUGGING.md](devtools-mcp/DEBUGGING.md)** guide for full tool reference
...
**See Also:** [devtools-mcp/DEBUGGING.md](devtools-mcp/DEBUGGING.md) for tool reference and best practices.
